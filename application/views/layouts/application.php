...
<div class="<?php print $message_class;?>">	<?php echo $this->template->message(); ?></div>
    ...
    <?php echo $this->template->yield(); ?>
    		<br/>
   <div class="menuitem"><a href="<?php print base_url()?>"><h2>Back Home</h2></a> <br /> Developed by <a href="http://geshan.blogspot.com">Geshan Manandhar</a> <br/> I am always against load shedding.</div>
